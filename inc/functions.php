...
class Homepage
{
    ...
    static function sumFieldAggFacebook()
    {
        ...
        $response = Elasticsearch::search(null, 0, $query);
        echo '<li class="list-group-item">Total de reactions no facebook: ' . $response["aggregations"]["facebook_reaction_count"]["value"] . '</li>';
        echo '<li class="list-group-item">Total de compartilhamentos no facebook: ' . $response["aggregations"]["facebook_share_count"]["value"] . '</li>';
        echo '<li class="list-group-item">Total de comentários no facebook: ' . $response["aggregations"]["facebook_comment_count"]["value"] . '</li>';
        echo '<li class="list-group-item">Total de interações no facebook: ' . $response["aggregations"]["facebook_total"]["value"] . '</li>';
    }
